...
**Measured status first:** [READINESS.md](READINESS.md) (progress bars from fixed criteria, regenerated by `python -m experiments.readiness.scoreboard --sync-docs`) and [CLAIMS.md](CLAIMS.md) (every number with its conditions).
