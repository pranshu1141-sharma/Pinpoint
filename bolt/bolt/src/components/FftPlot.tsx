...
import { formatFreqShort } from '@/lib/format';
...
export function FftPlot({
  ...
  useEffect(() => {
    ...
    ctx.textBaseline = 'bottom';
    ctx.font = '9px "JetBrains Mono", monospace';
    ctx.fillText(`Threshold ${thresholdDb.toFixed(1)} dB`, width - PAD_RIGHT - 4, thresholdY - 2);
    ...
    hoveredThreshold, draggingThreshold, plotHeight,
  ]);
