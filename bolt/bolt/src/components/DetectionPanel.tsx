...
import { formatFreq, formatConfidence, formatSamples } from '@/lib/format';
    ...
    <div className="flex flex-col h-full">
      ...
      {total === 0 ? (
        <div className="flex items-center justify-center flex-1 text-rf-text-secondary text-[11px] p-4">
          No detections. Run analysis to find signals.
        </div>
      ) : (
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-2 py-1.5 font-mono text-rf-text-secondary tabular-nums whitespace-nowrap">
                      {formatSamples(det.start_sample)}
                      <span className="mx-0.5">–</span>
                      {formatSamples(det.end_sample)}
                      <span className="text-rf-text-secondary ml-1">({(endTime - startTime).toFixed(3)}s)</span>
                    </td>
